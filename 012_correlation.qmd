...
```{r}
x <- factor(c("b", "c", "a", "d"), order = TRUE)
y <- factor(c("c", "b", "a", "d"), order = TRUE)
...
::: exercise
La @fig-zerocorr fornisce due esempi di correlazione nulla in presenza di una chiara relazione (non lineare) tra due variabili.
