...
Alcune distribuzioni di Poisson sono riportate nella figura @fig-examples-poisson-distrib.

```{r fig-examples-poisson-distrib, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE, fig.cap = "Alcune distribuzioni di Poisson."}
library("scales")
library("viridis")
...
::: {#exr-poisson-2}
Per i dati dell'@exr-poisson-1, si trovi la probabilità che un evento accada almeno 8 volte in un minuto.
:::
...
::: solution
Per la domanda (a), $\lambda = 6$ e la probabilità richiesta è
...
### Distribuzione discreta uniforme con $\textsf{R}$
